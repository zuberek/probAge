...
INPUT_PATH = '/afs/inf.ed.ac.uk/user/s17/s1768506/disk/methylation/wave1/wave1.h5ad'
META_DIR_PATH = '/afs/inf.ed.ac.uk/user/s17/s1768506/disk/methylation/genscot_meta/wave3'
META_DIR_PATH = '/afs/inf.ed.ac.uk/user/s17/s1768506/disk/methylation/genscot_meta/wave1'

print('Loading the dataset (it might take a while)...')
amdata = ad.read_h5ad(INPUT_PATH)
# amdata = ad.read_h5ad('../exports/wave3_linear.h5ad')


wave3cpgs = pd.read_csv('../exports/wave3cpgs.csv', index_col='index')
...
# keep only the sites overlapping with wave3 (ground truth)
amdata = amdata[amdata.obs.index.intersection(wave3cpgs.index)]
...
top_r2 = amdata.obs.sort_values('r2', ascending=False).index[:1024]
