...
plot.fonts(8)
g = sns.JointGrid()
sns.scatterplot(data=amdata.var, alpha=0.3, x='acc', y='bias', color='tab:grey', ax=g.ax_joint)
sns.kdeplot(data=amdata.var, levels=5, x='acc', y='bias', color='black',  ax=g.ax_joint)
