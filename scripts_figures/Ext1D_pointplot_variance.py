...
ax=sns.pointplot(data=var_df, x="bin", y="variance", 
                 errorbar='ci', capsize=.3, linewidth=2)

ax.get_figure().tight_layout()
# %%
ax.get_figure().savefig(f'{paths.FIGURES_DIR}/Ext1D_pointplot_variance.png')
ax.get_figure().savefig(f'{paths.FIGURES_DIR}/Ext1D_pointplot_variance.svg')
