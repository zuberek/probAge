...
DIR_PATH = '/mnt/tchandra-lab/EJYang/methylclock/Metadata_GS/wave1'
pheno = pd.read_csv(f'{DIR_PATH}/phenotypes_and_prevalent_disease.csv', index_col='Basename')
survival = pd.read_csv(f'{DIR_PATH}/survival.csv', index_col='Basename')
clock_results = pd.read_csv(f'{DIR_PATH}/DNAmAge_output.csv', index_col='Basename')
...
pheno.to_csv('../exports/wave1_participants.csv')
